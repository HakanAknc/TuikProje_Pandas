    ...
    if choice == '1':
        ...
        if csv_files:
            ...
            try:
                ...
                file_index = int(input("\nİşlem yapmak istediğiniz CSV dosyasının numarasını girin: ").strip()) - 1
                    ...
                    if os.path.isfile(file_path):
                        ...
                        def get_value(value, column):
                            ...
                            try:
                                ...
                                row = df[df[df.columns[0]].astype(str).str.lower().str.strip() == str(value).lower().strip()]
